...
var (
	...
	masterVolumeIdVersion         = cmdServer.Flag.Uint("master.volumeIdVersion", 1, "Volume id version used to create new volumes.")
	...
	*filerOptions.master = *serverIp + ":" + strconv.Itoa(*masterPort)
	...
	go func() {
		...
		ms := weed_server.NewMasterServer(r, *masterPort, *masterMetaFolder,
			*masterVolumeSizeLimitMB, storage.VolumeIdVersion(*masterVolumeIdVersion), *masterVolumePreallocate,
